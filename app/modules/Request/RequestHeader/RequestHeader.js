angular.module('RequestHeader', [])
    .controller('RequestHeaderController', ['$scope', 'userService', 'requestHeaderService', 'SidebarService', 'requestControllerService', 'exportExcelService',
        function ($scope, userService, requestHeaderService, SidebarService, requestControllerService, exportExcelService) {
            $scope.toasts = false;
            $scope.message = null;
            ...
            // Export Excel
            $scope.exportExcel = () => {
                const requestData = requestControllerService.getRequestData();
                const filename = 'Request';
                exportExcelService.exportExcel(requestData, filename);
            }
